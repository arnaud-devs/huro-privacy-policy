    ...
    <View className="bg-primary rounded-[20px] p-5 mb-6">
      <View className="flex-row justify-between items-start mb-3">
        ...
        <View className="bg-[#4AA0F9] px-3 py-1.5 rounded-xl items-center">
          <Text className="text-white text-[10px] opacity-90">Arrives</Text>
          <Text className="text-white text-sm font-bold">1h 20m</Text>
        </View>
      </View>

      <Text className="text-white text-[22px] font-bold mb-5">
        Next Campus Delivery
      </Text>

      <View className="flex-row justify-between mb-2">
        <Text className="text-white text-[13px]">Order window closing soon</Text>
        <Text className="text-white text-[13px] font-bold">75% Full</Text>
      </View>
      ...
      <TouchableOpacity className="bg-white rounded-xl h-11 flex-row justify-center items-center">
        ...
        <Text className="text-primary font-bold text-[15px] ml-2">
          Join Batch Delivery
        </Text>
      </TouchableOpacity>
    </View>

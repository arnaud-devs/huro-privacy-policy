...
const PRODUCTS = [
  { 
    ...
    price: "RWF 150", 
    image: "https://images.unsplash.com/photo-1566478989037-e6281fd470fa?auto=format&fit=crop&w=400&q=80" 
  },
  { 
    id: '2', 
    name: "A4 Print Paper (10...", 
    price: "RWF 180", 
    image: "https://images.unsplash.com/photo-1588666579624-9b22e11a3dbe?auto=format&fit=crop&w=400&q=80" 
  },
  { 
    id: '3', 
    name: "Fast USB-C Cable...", 
    price: "RWF 180", 
    image: "https://images.unsplash.com/photo-1624823183533-3d0b2ac84587?auto=format&fit=crop&w=400&q=80" 
  },
  { 
    id: '4', 
    name: "Spiral Notebook A5", 
    price: "RWF 180", 
    image: "https://images.unsplash.com/photo-1531346878377-a5406c59b207?auto=format&fit=crop&w=400&q=80" 
  },
  { 
    id: '5', 
    name: "Fresh Milk 1L", 
    ...
    <View className="px-4 mt-2 mb-6">
      ...
      <View className="flex-row flex-wrap justify-between">
        {PRODUCTS.map(product => (
          <View key={product.id} className="w-[48%] bg-white rounded-[20px] p-2 mb-4 border border-slate-100 shadow-sm">
